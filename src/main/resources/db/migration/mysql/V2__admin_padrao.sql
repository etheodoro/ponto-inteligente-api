...
VALUES (NULL, '82198127000121', CURRENT_DATE(), CURRENT_DATE(), 'ELT TI');
...
VALUES (NULL, '16248890935', CURRENT_DATE(), CURRENT_DATE(), 'evandrolt@gmail.com', 'ADMIN', 'ROLE_ADMIN', NULL, NULL, 
